	...
	public partial class UserControl1 : System.Windows.Controls.UserControl
	{
		...
		private void FilterBasic_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				if (System.Windows.MessageBox.Show("Tiến hành lọc Id", "Xác nhận lọc Id", MessageBoxButton.YesNo) == MessageBoxResult.Yes)
				{
					...
					if (BankExcer.IsChecked == true && ConfigurationManager.AppSettings["A"] != "0")
					{
					...
					if (sortoder.IsChecked == true&& ConfigurationManager.AppSettings["A"] != "0")
					{
					...
					if (DevideFile.IsChecked == true&&ConfigurationManager.AppSettings["A"] != "0")
					{
					...
					if (listex != null&& listex.Count > 0 && ConfigurationManager.AppSettings["A"] != "0")
					{
		...
		private void FilterAdvandedStart_Click(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				if (listend != null && listend.Count > 0&&DevideFile.IsChecked == true && ConfigurationManager.AppSettings["A"] != "0")
				{
				...
				if (listend != null&&listend.Count>0 && ConfigurationManager.AppSettings["A"] != "0")
				{
					if (commentorder.IsChecked == true)
					{
						User1Before classBefore = new User1Before();
